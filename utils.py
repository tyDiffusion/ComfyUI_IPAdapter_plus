...
def get_clipvision_file(preset):
    ...
    if preset.startswith("vit-g"):
        pattern = r'(clip_g|ViT.bigG.14.*39B.b160k|ipadapter.*sdxl|sdxl.*model\.(bin|safetensors))'
    else:
        pattern = r'(clip_h|ViT.H.14.*s32B.b79K|ipadapter.*sd15|sd1.?5.*model\.(bin|safetensors))'
